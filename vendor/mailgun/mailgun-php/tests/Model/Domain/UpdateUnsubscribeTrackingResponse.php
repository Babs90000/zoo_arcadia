...
use Mailgun\Model\Domain\UpdateUnsubscribeTrackingResponse as UpdateUnsubscribeTrackingResponseAlias;
use Mailgun\Tests\Model\BaseModel;

class UpdateUnsubscribeTrackingResponse extends BaseModel
{
...
JSON;
        $model = UpdateUnsubscribeTrackingResponseAlias::create(json_decode($json, true));
