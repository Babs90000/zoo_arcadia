...
use Mailgun\Model\MailingList\PagesResponse as PagesResponseAlias;
use Mailgun\Tests\Model\BaseModel;

class PagesResponse extends BaseModel
{
...
JSON;
        $model = PagesResponseAlias::create(json_decode($json, true));
