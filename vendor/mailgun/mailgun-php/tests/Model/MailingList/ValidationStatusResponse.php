...
use Mailgun\Model\MailingList\ValidationStatusResponse as ValidationStatusResponseAlias;
...
class ValidationStatusResponse extends BaseModel
{
...
JSON;
        $model = ValidationStatusResponseAlias::create(json_decode($json, true));
