<?php define('ROOT_PATH', __DIR__ . '/'); // Définir la racine du projet

// Inclure le fichier header.php depuis le dossier template
...
<?php require_once ROOT_PATH . 'template/footer.php'; ?>