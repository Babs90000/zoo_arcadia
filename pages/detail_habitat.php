                    ...
                    if ($habitat) {
                        ...
                        if ($habitat['image_data']) {
                            echo '<img src="data:image/jpeg;base64,' . base64_encode($habitat['image_data']) .
                             '" alt="Image de l\'habitat" class="img-fluid mb-3" style="max-width: 600px;">';
                        }
                        ...
                        if (count($animaux) > 0) {
                            ...
                            foreach ($animaux as $animal) {
                                echo "<li class='list-group-item'><a href='detail_animal.php?animal_id=" . htmlspecialchars($animal['animal_id']) . "'>" 
                                . $animal['prenom'] . " - " . $animal['label'] . "</a></li>";
                            }
                            echo "</ul>";
                        } else {
                            echo "<p>" . htmlspecialchars("Aucun animal dans cet habitat.") . "</p>";
                        }
                    } else {
                        echo "<p>" . htmlspecialchars("Habitat non trouvé.") . "</p>";
                    }
                } else {
