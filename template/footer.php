...
define('ROOT_PATH', '96BCD66/'); // Assurez-vous que cette constante pointe vers la racine de votre projet
...
<footer>
  ...
  <div class="adresse_et_contact">
    ...
    <p><strong>Contact</strong><br>
      <a href="<?php echo ROOT_PATH; ?>pages/formulaire_contact.php"><i class="bi bi-envelope-at-fill"></i> Formulaire de contact</a><br>
